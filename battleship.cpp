...
void setting() {
    ...
    switch (option) {
        ...
        case 4:
            ...
            total_size = carrier * 5 + battleship * 4 + submarine * 3 + destroyer * 2;
            playercarrier = carrier; playerbattleship = battleship; playersubmarine = submarine; playerdestroyer = destroyer;
            playership = playercarrier + playerbattleship + playersubmarine + playerdestroyer;
            AIcarrier = carrier; AIbattleship = battleship; AIsubmarine = submarine; AIdestroyer = destroyer;
